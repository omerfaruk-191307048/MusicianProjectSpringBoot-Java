...
public class InstrumentListExcelHelper {
    static String[] HEADERs = { "Instrument ID","Instrument Name","Instrument Mark","Instrument Kind" };

    static String SHEET = "Instruments";
    ...
    public InstrumentListExcelHelper(List<Instrument> instruments){
    ...
    public void export(HttpServletResponse response) throws IOException {
        ...
        rowFontStyle.setColor(IndexedColors.ORANGE.getIndex());
        ...
        for (Instrument instrument : instruments){
            ...
            cell.setCellValue(instrument.getInstrumentId());
            ...
            cell.setCellValue(instrument.getInstrumentMark());
            sheet.autoSizeColumn(2);
            cell.setCellStyle(rowCellStyle);

            cell = dataRow.createCell(3);
            cell.setCellValue(instrument.getInstrumentKind());
